...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0004_auto_20220118_1320'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PD', 'оплачен'), ('PRD', 'обрабатывается'), ('RDY', 'готов к выдаче'), ('CNC', 'отменен')], max_length=3, verbose_name='статус')),
